        ...
        <div className="row gy-4">
          <div className="col-lg-4 col-md-6 footer-about">
            <a href="index.html" className="logo d-flex align-items-center">
              <span className="sitename">LabFry Technology</span>
            </a>
            <div className="footer-contact pt-3">
              <p>Rahattarpul Bangladesh</p>
              <p>Chattogram, 4203</p>
              <p className="mt-3"><strong>Phone:</strong> <span>01914-230557</span></p>
              <p><strong>Email:</strong> <span>hr@labfry.com</span></p>
            </div>
